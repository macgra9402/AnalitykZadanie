...
Event Storming dobrze pokazuje fakty, decyzje, aktorów, systemy i pain pointy. W tym zadaniu pomaga udowodnić, że kandydat rozumie proces biznesowy, a nie tylko rysuje architekturę integracyjną.
