...
Projekt nie zakłada portalu klienta, zastąpienia SAP lub JIRA, pełnej automatycznej akceptacji/rejekcji reklamacji ani trenowania własnego modelu computer vision. Priorytetem jest realny MVP możliwy do obrony w rozmowie technicznej.
